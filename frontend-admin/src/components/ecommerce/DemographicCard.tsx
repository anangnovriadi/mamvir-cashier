...
export default function DemographicCard() {
  ...
  return (
    <div className="rounded-lg border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] sm:p-6">
      ...
      <div className="px-4 py-6 my-6 overflow-hidden border border-gary-200 rounded-lg dark:border-gray-800 sm:px-6">
        <div
          id="mapOne"
      ...
      <div className="space-y-5">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex w-full max-w-[140px] items-center gap-3">
            <div className="relative block h-2 w-full max-w-[100px] rounded-lg bg-gray-200 dark:bg-gray-800">
              <div className="absolute left-0 top-0 flex h-full w-[23%] items-center justify-center rounded-lg bg-brand-500 text-xs font-medium text-white"></div>
            </div>
            <p className="font-medium text-gray-800 text-theme-sm dark:text-white/90">
              23%
            </p>
