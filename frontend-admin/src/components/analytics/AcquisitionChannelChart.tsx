...
export default function AcquisitionChannelChart() {
  ...
  const options: ApexOptions = {
    colors: ["var(--color-mamvir-700)", "var(--color-mamvir-500)", "var(--color-mamvir-300)", "var(--color-mamvir-100)"],
    chart: {
  ...
  return (
    <div className="rounded-lg border border-gray-200 bg-white px-5 pt-5 dark:border-gray-800 dark:bg-white/[0.03] sm:px-6 sm:pt-6">
